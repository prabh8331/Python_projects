...
app.layout = html.Div([
    html.H1("Story Dashboard", style={'text-align': 'center'}),  # Center the text
    dcc.Tabs([
            ...
            html.Div([
                html.Div([
                    dcc.Checklist(
                        ...
                        style={'margin-bottom': '10px'}  # Example of inline CSS styling
                    ),
                ], style={'float': 'right'}),
                html.Div([
...
], style={'font-family': 'Arial, sans-serif', 'padding': '20px'})  # Example of inline CSS styling for the overall layout
